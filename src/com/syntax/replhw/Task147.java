...
public class Task147 {
    ...
    Task147(String label,double price,String category,boolean hasExpiration,int stock){
        this.label=label;
        this.price=price;
    ...
    Task147(String label,double price,int stock){
        this.label=label;
        this.price=price;
        this.category="misc";
    ...
    Task147(String label,double price){
        this.label=label;
        this.price=price;
    }
    void display(){
